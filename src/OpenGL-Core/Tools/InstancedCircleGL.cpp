...
InstancedCircleGL::InstancedCircleGL(unsigned int circleEdgeNumber) : circleEdgeNumber(circleEdgeNumber) {
    createVAO();
}

InstancedCircleGL::~InstancedCircleGL() {
    glDeleteVertexArrays(1, &VAO);
    glDeleteBuffers(1, &VBO);
    glDeleteBuffers(1, &EBO);
}

void InstancedCircleGL::draw() {
...
void InstancedCircleGL::setNumberInstance(unsigned int numberInstance) {
    m_numberInstance = numberInstance;
}

void InstancedCircleGL::setModelMatrices(glm::mat4* modelMatrices) {
...
void InstancedCircleGL::createVAO() {
